	...
	<div class="row-fluid">
		...
		<div class="span4">
			<div class="input-prepend input-block-level">
			  ...
			  <input type="text" name="username" id="username" tabindex="1" placeholder="<?php echo JText::_('COM_COMMUNITY_EMAIL'); ?>" />
			</div>
		</div>
        ...
        <div class="span3"><gavern:fblogin> <span id="fb-auth"><small>fb icon</small><?php echo JText::_('TPL_GK_LANG_FB_LOGIN_TEXT'); ?></span> </gavern:fblogin></div>
