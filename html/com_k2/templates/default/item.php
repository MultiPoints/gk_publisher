...
<article id="k2Container" class="itemView<?php echo $k2ContainerClasses; ?>"> <?php echo $this->item->event->BeforeDisplay; ?> <?php echo $this->item->event->K2BeforeDisplay; ?>
	...
	<section>
		...
		<a class="itemEditLink modal" rel="{handler:'iframe',size:{x:990,y:550}}" href="<?php echo $this->item->editLink; ?>">
		...
		<header>
			...
			<ul>
				...
				<li>
					<?php if(($params->get('itemPrintButton') || $params->get('itemEmailButton')) && !JRequest::getInt('print')): ?>
					<a class="itemPrintLink" rel="nofollow" href="<?php echo $this->item->printLink; ?>" onclick="window.open(this.href,'printWindow','width=900,height=600,location=no,menubar=no,resizable=yes,scrollbars=yes'); return false;"> <?php echo JText::_('K2_PRINT'); ?> </a>
					<?php endif; ?>
				
					<?php if($params->get('itemEmailButton') && !JRequest::getInt('print')): ?>
					<a class="itemEmailLink" rel="nofollow" href="<?php echo $this->item->emailLink; ?>" onclick="window.open(this.href,'emailWindow','width=400,height=350,location=no,menubar=no,resizable=no,scrollbars=no'); return false;"> <?php echo JText::_('K2_EMAIL'); ?> </a>
					<?php endif; ?>
				</li>
				<?php endif; ?>
		...
		<div class="itemBody">
			...
			<div class="itemInfoBlock">				
				...
				<?php if(
					...
					<div class="itemInfo">
						...
						<ul>
							...
							<li> <?php echo JText::_('K2_READ'); ?> <strong><?php echo $this->item->hits; ?></strong> <?php echo JText::_('K2_TIMES'); ?> </li>
							<?php endif; ?>
						</ul>
						<?php endif; ?>
				...
				<div class="itemAuthorContent<?php if($params->get('itemRelated') && isset($this->relatedItems)) : ?> itemAuthorContent2Col<?php endif; ?>">
					<?php if($params->get('itemAuthorLatest') && empty($this->item->created_by_alias) && isset($this->authorLatestItems)): ?>
				...
				<div class="itemAuthorContent<?php if($params->get('itemAuthorLatest') && empty($this->item->created_by_alias) && isset($this->authorLatestItems)) : ?> itemAuthorContent2Col<?php endif; ?>">
